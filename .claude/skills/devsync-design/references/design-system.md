...
## Index — what lives in this skill package

```
devsync-design/
├── SKILL.md                   ← skill manifest for Codex / Claude Code
├── agents/
│   └── openai.yaml            ← Codex UI metadata
├── references/
│   ├── design-system.md       ← you are here
│   ├── iconography.md         ← Lucide usage and substitution notes
│   └── ui-kit.md              ← React kit file map
...
│   └── wireframes/            ← reference wireframe images
...
└── ui_kits/
    └── devsync-app/
        ...
        ├── primitives.jsx     ← Icon, Button, Badge, Avatar
        ├── Sidebar.jsx
        ├── TopBar.jsx
        ├── Kanban.jsx
        ├── Dashboard.jsx
